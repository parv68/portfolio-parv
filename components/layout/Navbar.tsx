        ...
        <div className="fixed inset-0 top-16 z-40 bg-background md:hidden">
          <nav className="flex flex-col gap-6 p-8">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded-lg border border-border px-4 py-2 text-base transition-colors hover:bg-secondary cursor-pointer text-muted-foreground hover:text-foreground"
            >
              <Terminal size={16} />
              Open Terminal CLI
            </button>
            <button
              ...
              className="inline-flex items-center justify-center rounded-lg border border-border px-4 py-2 text-base transition-colors hover:bg-secondary cursor-pointer font-medium text-foreground"
            >
              View Resume ↗
            </button>
          </nav>
